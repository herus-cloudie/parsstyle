    ...
    variants: {
      variant: {
        ...
        destructive:
          ...
          successful:
          "destructive group border-green-700 bg-green-700 text-slate-100 dark:border-green-900 dark:bg-green-900 dark:text-slate-50",
      },
    },
    defaultVariants: {
      variant: "default",
...
const ToastAction = React.forwardRef(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ...
    className={cn(
      "border px-3 py-1 rounded border-red hover:bg-black hover:border-black",
